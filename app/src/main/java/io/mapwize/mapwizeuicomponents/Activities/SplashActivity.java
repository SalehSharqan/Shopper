...
public class SplashActivity extends AppCompatActivity {
    ...
    public String userType, useremail;
    Users users;
                        ...
                        reff.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                    ...
                                    else if(users.getUserType().equals("Retailer")  ) {

                                            if (users.getR_Email().equals(useremail)) {
                                                Intent intent = new Intent(SplashActivity.this , RetailerMain.class);
                                                startActivity(intent);
                                                finish();
                                            }
                                    }
                            ...
                            public void onCancelled(@NonNull DatabaseError databaseError) {
                                Toast.makeText(SplashActivity.this , "Opsss.... Something is wrong" , Toast.LENGTH_SHORT).show();
