...
public class ReProductsList extends Fragment {
    ...
    public  String userType, currentuser, Emaill;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        reff2 = FirebaseDatabase.getInstance().getReference().child("Shops");
        reff2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    {
                        currentuser = shops.getOwnerEmail();
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshot1: dataSnapshot.getChildren())
                {
                    ...
                    Products products = dataSnapshot1.getValue(Products.class);
                        ...
                        if (products.getShopOwner().equals(Emaill)) {
                          //  Toast.makeText(getActivity(), Emaill + " + " + products.getShopOwner(), Toast.LENGTH_SHORT).show();
